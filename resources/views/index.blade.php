...
<head>
<!-- Referencia o arquivo javascript do public -->
    ...
    <link rel="icon" href="{{ asset('icon/favicon-32x32') }}" sizes="32x32" type="image/png">
    <link rel="icon" href="{{ asset('icon/favicon-16x16') }}" sizes="16x16" type="image/png">
...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark"> <a
            class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="#">Ash-Greninja</a>
